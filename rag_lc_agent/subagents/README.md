...
* **Failure Enforcement**: If the Candidate Answer contains phrases implying uncertainty, the Evaluator issues a `not_answerable` grade, which signals the main conversational router to systematically fallback.
